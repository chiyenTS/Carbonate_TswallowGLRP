...
#PBS -N Braker_run8
#PBS -l nodes=1:ppn=8,vmem=64gb,walltime=14:00:00:00
...
## Run8 using Barn swallow protein database to train augustus 

cd /N/dc2/projects/Tswallow_GLRP/CT/Braker_annotation/Run8
braker.pl --species=Tachycineta_bicolor_run8 --genome=Renamed_tswallow_contig.fasta \
       --bam=Renamed_tswallow_contig.bam --prot_seq=Barn_swallow_ET.fasta \
       --prg=gth --gth2traingenes --softmasking
