...
## Run6 uses only RNA-Seq data for Braker Run add 2010 to 2016 RNAseq reads after digitalnormalization with alignment score 0.3 
...
cd /N/dc2/projects/Tswallow_GLRP/CT/Braker_annotation/Run6
braker.pl --species=Tachycineta_bicolor_run6 --genome=Renamed_tswallow_contig.fasta \
       --bam=all.10brids.0.3score.bam,all.2010to2016.score0.3.bam \
       --softmasking --cores=8
