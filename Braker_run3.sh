...
## Run3 use protein database from de novo assembly okay and okayalt.aa instead of ave_proteome
...
cd /N/dc2/projects/Tswallow_GLRP/CT/Braker_annotation/Run3
braker.pl --species=Tachycineta_bicolor3 --genome=Renamed_tswallow_contig.fasta \
       --bam=Renamed_tswallow_contig.bam --prot_seq=Renamed_transcriptome_combined_protein.fa \
