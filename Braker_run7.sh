...
#PBS -N Braker_run7
#PBS -l nodes=1:ppn=8,vmem=64gb,walltime=12:00:00:00
...
cd /N/dc2/projects/Tswallow_GLRP/CT/Braker_annotation/Run7
braker.pl --species=Tachycineta_bicolor_run7 --genome=Renamed_tswallow_contig.fasta \
