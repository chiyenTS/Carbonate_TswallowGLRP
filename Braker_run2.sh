...
#PBS -N Braker_run2
#PBS -l nodes=1:ppn=8,vmem=72gb,walltime=7:00:00:00
...
cd /N/dc2/projects/Tswallow_GLRP/CT/Braker_annotation/Run2
braker.pl --species=Tachycineta_bicolor_run2 --genome=Renamed_tswallow_contig.fasta \
