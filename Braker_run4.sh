...
## Run4 use protein hint from maker_run3.gff which is the result after snap prediction 
...
cd /N/dc2/projects/Tswallow_GLRP/CT/Braker_annotation/Run4
braker.pl --species=Tachycineta_bicolor_run4 --genome=Renamed_tswallow_contig.fasta \
       --bam=Renamed_tswallow_contig.bam --hints=TswallowMaker3.all.gff \
       --etpmode --softmasking --cores=8
